...
async def get_ai_usage(
    ...
    """
    Aggregated AI usage telemetry for admins.

    Returns provider/task/model/status aggregates only. Raw organization IDs,
    prompts, responses, document names, and user details are intentionally omitted.
    """
