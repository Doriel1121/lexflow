...
class Organization(Base):
    ...
    ai_daily_call_limit = Column(Integer, nullable=True, default=1000)
    ai_monthly_drafting_limit = Column(Integer, nullable=True, default=100)
    ai_monthly_token_limit = Column(Integer, nullable=True, default=None)
