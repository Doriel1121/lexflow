                    ...
                    <>
                      ...
                      {caseNumbers.length > 0 &&
                        caseNumbers.map((cn, i) => (
                          <span
                            key={i}
                            className="px-3 py-1 bg-purple-50 text-purple-700 border border-purple-200 rounded-full text-sm font-medium flex items-center gap-1"
                          >
                  ...
                  <>
                    ...
                    {allEntities.length > 4 && (
                      ...
                      >
                        {showAllEntities
                          ? "Show less"
                          : `+${allEntities.length - 4} more parties`}
                      </button>
                    )}
                  </>
                ) : (
