...
export function OrgAdminOverview() {
  ...
  const cards = [
    ...
    {
      label: t("dashboardPage.dueIn7Days"),
      value: summary.upcoming_deadlines_7d,
      icon: Clock,
      color: "text-amber-600 bg-amber-50",
    },
    {
      label: t("dashboardPage.unassigned"),
    ...
    },
    {
      ...
      value: `${summary.deadline_compliance_rate}%`,
      icon: CheckCircle,
      color:
        summary.deadline_compliance_rate >= 80
