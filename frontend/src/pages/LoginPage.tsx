      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <div className="mb-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
          <p className="text-sm text-yellow-800 dark:text-yellow-200 mb-3">
            <strong>🛠️ {t("documentList.developmentMode")}:</strong>{" "}
            {t("documentList.developmentModeDesc")}
          </p>
          <form onSubmit={handleDevLogin} className="space-y-3">
            <input
              type="email"
              placeholder={t("documentList.devLoginPlaceholder")}
              value={email}
            ...
            >
              {loading
                ? `⏳ ${t("documentList.loggingIn")}`
                : `🚀 ${t("documentList.devLogin")}`}
            </button>
          </form>
        </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white dark:bg-gray-800 text-gray-500">
              {t("documentList.continueWithOAuth")}
            </span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <span className="text-gray-700 dark:text-gray-200 font-medium">
              {t("documentList.continueWithGoogle")}
            </span>
          </button>
          ...
          >
            ...
            <span className="text-gray-700 dark:text-gray-200 font-medium">
              {t("documentList.continueWithMicrosoft")}
            </span>
          </button>
        </div>

        <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          🔒 {t("documentList.secureAuth")}
        </p>
      </div>
    </div>
  );
