  ...
  const loadPage = useCallback(
    async (targetPage: number, reset = false) => {
      try {
        ...
        const incoming: AuditLogEntry[] = Array.isArray(res.logs)
          ? res.logs
          : [];

        setTotal(res.total ?? 0);
        setLogs((prev) =>
          reset || targetPage === 1 ? incoming : [...prev, ...incoming],
        );
                ...
                <tr>
                  ...
                  >
                    {searchTerm
                      ...
                      : t("auditLogs.admin.noAuditEvents")}
                  </td>
                </tr>
              )}
                ...
                filteredLogs.map((log) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      ...
                      {log.resource_type && (
                        <span className="text-[10px] text-slate-400 ms-[18px]">
                          {log.resource_type}
                        </span>
                      )}
                    </td>
