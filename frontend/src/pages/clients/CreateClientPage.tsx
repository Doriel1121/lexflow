...
export const CreateClientPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.detail || err.message || "Failed to create client",
      );
      setLoading(false);
    }
  };
    ...
    <div className="p-4 max-w-2xl mx-auto py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-2">
          Verify the entity's risk profile before creation.
        </p>
      </div>
      ...
      <form
        ...
        className="bg-white border border-slate-200 rounded-xl shadow-sm p-6 mt-6 space-y-5"
      >
        ...
        <div>
          ...
          <input
            ...
            placeholder={t("clients.entityNamePlaceholder")}
            required
          />
        </div>
